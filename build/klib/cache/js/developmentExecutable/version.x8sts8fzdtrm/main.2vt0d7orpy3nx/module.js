(function (root, factory) {
  ...
  var charArrayOf = kotlin_kotlin.$_$.k3;
  var split = kotlin_kotlin.$_$.p4;
  var copyToArray = kotlin_kotlin.$_$.v1;
  var startsWith = kotlin_kotlin.$_$.r4;
  var indexOf = kotlin_kotlin.$_$.m4;
  var ensureNotNull = kotlin_kotlin.$_$.i5;
  var to = kotlin_kotlin.$_$.n5;
  var json = kotlin_kotlin.$_$.y3;
  ...
  var toDouble = kotlin_kotlin.$_$.s4;
  var round = kotlin_kotlin.$_$.g4;
  var isBlank = kotlin_kotlin.$_$.n4;
  var await_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.a;
  var isArray = kotlin_kotlin.$_$.v3;
  var arrayIterator = kotlin_kotlin.$_$.i3;
  var checkIndexOverflow = kotlin_kotlin.$_$.t1;
  var split_0 = kotlin_kotlin.$_$.q4;
  var joinToString = kotlin_kotlin.$_$.b2;
  var emptyList = kotlin_kotlin.$_$.w1;
  var getOrNull = kotlin_kotlin.$_$.z1;
  ...
  setMetadataFor(main$renderDashboard$slambda, 'main$renderDashboard$slambda', classMeta, CoroutineImpl, [CoroutineImpl], VOID, VOID, VOID, [1]);
  setMetadataFor(main$renderLogin$lambda$slambda, 'main$renderLogin$lambda$slambda', classMeta, CoroutineImpl, [CoroutineImpl], VOID, VOID, VOID, [1]);
  ...
  function main$renderDashboard(loginContainer, dashboardContainer, dashboardHTML, navLinks, auth, db) {
    ...
    navLinks.innerHTML = '<li><button id="logoutBtn" class="nav-link">\xC7\u0131k\u0131\u015F Yap<\/button><\/li>';
  ...
  function main$renderDashboard$slambda$lambda_2($modalId, $db, $userUid) {
    return function (_anonymous_parameter_0__qggqh8) {
      ...
      // Inline function 'com.kapgan.dermai.main.renderDashboard.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>' call
      this_0.once = true;
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 3:
            ...
            var tmp_3 = this;
            tmp_3.this5__1 = this.userDocs4__1;
            this.tmp0_iterator6__1 = arrayIterator(this.this5__1);
            this.set_state_rjd8d0_k$(4);
            continue $sm;
          case 4:
          ...
          case 5:
            var tmp_4 = this;
            tmp_4.doc9__1 = this.element7__1;
            var tmp_5 = this;
            var tmp_6 = this.doc9__1.id;
            tmp_5.userUid10__1 = (!(tmp_6 == null) ? typeof tmp_6 === 'string' : false) ? tmp_6 : THROW_CCE();
            this.set_state_rjd8d0_k$(6);
            suspendResult = getUserData(this.$db_1, this.userUid10__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 6:
            ...
            if (user.diseases.isEmpty_y1axqb_k$() ? true : user.usertype === 'derm') {
          ...
          case 7:
            ...
            var index = 0;
            var tmp0_iterator = user.diseases.iterator_jk1svi_k$();
            while (tmp0_iterator.hasNext_bitz1p_k$()) {
              ...
              confirmBtn.addEventListener('click', main$renderDashboard$slambda$lambda_1(this.$db_1, this.userUid10__1, confirmBtn));
              var commentBtn = document.createElement('button');
              commentBtn.setAttribute('class', 'btn btn-primary btn-sm');
              commentBtn.textContent = 'Yorum Ekle';
              var modalId = 'commentModal-' + this.userUid10__1 + '-' + index_0;
              ...
              commentBtn.addEventListener('click', main$renderDashboard$slambda$lambda_2(modalId, this.$db_1, this.userUid10__1));
  ...
  function main$renderDashboard$lambda(_anonymous_parameter_0__qggqh8) {
    deleteCookie('userAuth');
  ...
  protoOf($getUserDataCOROUTINE$0).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
