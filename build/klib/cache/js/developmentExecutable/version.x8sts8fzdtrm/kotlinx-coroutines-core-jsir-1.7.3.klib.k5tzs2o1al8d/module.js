(function (root, factory) {
  ...
  var Continuation = kotlin_kotlin.$_$.w2;
  ...
  var createCoroutineUnintercepted = kotlin_kotlin.$_$.p2;
  var intercepted = kotlin_kotlin.$_$.q2;
  ...
  var get_COROUTINE_SUSPENDED = kotlin_kotlin.$_$.n2;
  var objectMeta = kotlin_kotlin.$_$.b4;
  var hashCode = kotlin_kotlin.$_$.t3;
  ...
  var AbstractCoroutineContextKey = kotlin_kotlin.$_$.s2;
  var Key_getInstance = kotlin_kotlin.$_$.h1;
  var AbstractCoroutineContextElement = kotlin_kotlin.$_$.r2;
  var get = kotlin_kotlin.$_$.t2;
  var minusKey = kotlin_kotlin.$_$.u2;
  var ContinuationInterceptor = kotlin_kotlin.$_$.v2;
  var Key = kotlin_kotlin.$_$.b3;
  var Element = kotlin_kotlin.$_$.a3;
  var RuntimeException_init_$Create$ = kotlin_kotlin.$_$.y;
  var THROW_IAE = kotlin_kotlin.$_$.e5;
  var Enum = kotlin_kotlin.$_$.w4;
  var startCoroutine = kotlin_kotlin.$_$.f3;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.j5;
  var startCoroutine_0 = kotlin_kotlin.$_$.g3;
  var Long = kotlin_kotlin.$_$.a5;
  ...
  var captureStack = kotlin_kotlin.$_$.j3;
  var Error_0 = kotlin_kotlin.$_$.x4;
  var Error_init_$Init$ = kotlin_kotlin.$_$.o;
  var ArrayList_init_$Create$ = kotlin_kotlin.$_$.d;
  var CancellationException = kotlin_kotlin.$_$.m2;
  var ArrayList = kotlin_kotlin.$_$.n1;
  var CoroutineImpl = kotlin_kotlin.$_$.d3;
  var SequenceScope = kotlin_kotlin.$_$.k4;
  var IllegalStateException_init_$Create$_0 = kotlin_kotlin.$_$.t;
  var sequence = kotlin_kotlin.$_$.l4;
  var plus = kotlin_kotlin.$_$.c3;
  var get_0 = kotlin_kotlin.$_$.y2;
  var fold = kotlin_kotlin.$_$.x2;
  var minusKey_0 = kotlin_kotlin.$_$.z2;
  var throwUninitializedPropertyAccessException = kotlin_kotlin.$_$.l5;
  ...
  var SuspendFunction1 = kotlin_kotlin.$_$.e3;
  var UnsupportedOperationException = kotlin_kotlin.$_$.f5;
  var objectCreate = kotlin_kotlin.$_$.a4;
  ...
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.k5;
  var Exception = kotlin_kotlin.$_$.y4;
  var Exception_init_$Init$ = kotlin_kotlin.$_$.p;
  var toLongOrNull = kotlin_kotlin.$_$.t4;
  var createCoroutineUnintercepted_0 = kotlin_kotlin.$_$.o2;
  var isSuspendFunction = kotlin_kotlin.$_$.x3;
  var List = kotlin_kotlin.$_$.p1;
  var Collection = kotlin_kotlin.$_$.o1;
  var plus_0 = kotlin_kotlin.$_$.h2;
  var listOf_0 = kotlin_kotlin.$_$.c2;
  var getKClassFromExpression = kotlin_kotlin.$_$.a;
  var CancellationException_init_$Init$_0 = kotlin_kotlin.$_$.l;
  var getStringHashCode = kotlin_kotlin.$_$.s3;
  var removeFirstOrNull = kotlin_kotlin.$_$.i2;
  var MutableList = kotlin_kotlin.$_$.q1;
  var coerceIn = kotlin_kotlin.$_$.i4;
  ...
  setMetadataFor($hasNextCOROUTINE$3, '$hasNextCOROUTINE$3', classMeta, CoroutineImpl);
  ...
  setMetadataFor($receiveCOROUTINE$1, '$receiveCOROUTINE$1', classMeta, CoroutineImpl);
  setMetadataFor($receiveCatchingCOROUTINE$2, '$receiveCatchingCOROUTINE$2', classMeta, CoroutineImpl);
  ...
  setMetadataFor($invokeBlockCOROUTINE$10, '$invokeBlockCOROUTINE$10', classMeta, CoroutineImpl);
  setMetadataFor(ClauseData, 'ClauseData', classMeta, VOID, VOID, VOID, VOID, VOID, [1]);
  setMetadataFor($doSelectCOROUTINE$6, '$doSelectCOROUTINE$6', classMeta, CoroutineImpl);
  setMetadataFor($doSelectSuspendCOROUTINE$7, '$doSelectSuspendCOROUTINE$7', classMeta, CoroutineImpl);
  setMetadataFor($completeCOROUTINE$8, '$completeCOROUTINE$8', classMeta, CoroutineImpl);
  setMetadataFor($processResultAndInvokeBlockRecoveringExceptionCOROUTINE$9, '$processResultAndInvokeBlockRecoveringExceptionCOROUTINE$9', classMeta, CoroutineImpl);
  ...
  function $hasNextCOROUTINE$3(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($hasNextCOROUTINE$3).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(BufferedChannelIterator).hasNext_nhy1w3_k$ = function ($completion) {
    var tmp = new $hasNextCOROUTINE$3(this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  function $sendCOROUTINE$0(_this__u8e3s4, element, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
    this.element_1 = element;
  }
  protoOf($sendCOROUTINE$0).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $receiveCOROUTINE$1(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($receiveCOROUTINE$1).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $receiveCatchingCOROUTINE$2(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($receiveCatchingCOROUTINE$2).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(BufferedChannel).send_44jogj_k$ = function (element, $completion) {
    var tmp = new $sendCOROUTINE$0(this, element, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  protoOf(BufferedChannel).receive_awoumx_k$ = function ($completion) {
    var tmp = new $receiveCOROUTINE$1(this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(BufferedChannel).receiveCatching_golgg7_k$ = function ($completion) {
    var tmp = new $receiveCatchingCOROUTINE$2(this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
  ...
  function $invokeBlockCOROUTINE$10(_this__u8e3s4, argument, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
    this.argument_1 = argument;
  }
  protoOf($invokeBlockCOROUTINE$10).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function doSelectSuspend($this, $completion) {
    var tmp = new $doSelectSuspendCOROUTINE$7($this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  ...
  function complete($this, $completion) {
    var tmp = new $completeCOROUTINE$8($this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  function processResultAndInvokeBlockRecoveringException($this, clause, internalResult, $completion) {
    var tmp = new $processResultAndInvokeBlockRecoveringExceptionCOROUTINE$9($this, clause, internalResult, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  ...
  protoOf(ClauseData).invokeBlock_xrc4lb_k$ = function (argument, $completion) {
    var tmp = new $invokeBlockCOROUTINE$10(this, argument, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  function $doSelectCOROUTINE$6(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($doSelectCOROUTINE$6).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $doSelectSuspendCOROUTINE$7(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($doSelectSuspendCOROUTINE$7).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $completeCOROUTINE$8(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($completeCOROUTINE$8).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $processResultAndInvokeBlockRecoveringExceptionCOROUTINE$9(_this__u8e3s4, clause, internalResult, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
    this.clause_1 = clause;
    this.internalResult_1 = internalResult;
  }
  protoOf($processResultAndInvokeBlockRecoveringExceptionCOROUTINE$9).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(SelectImplementation).doSelect_2tssk0_k$ = function ($completion) {
    var tmp = new $doSelectCOROUTINE$6(this, $completion);
    tmp.set_result_xj64lm_k$(Unit_getInstance());
    tmp.set_exception_px07aa_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
